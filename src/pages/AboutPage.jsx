    ...
    <div className="about-page" style={introStyles}>
      <section id="about" className="about-section" style={introStyles}>
        ...
        <div className="about-text">
          ...
          <p style={pTagStyles}>
            29 years old, originally from Brazil and currently based in Amsterdam. Over the years, I’ve lived in Ireland and Portugal, each of which shaped who I am today. Although I’m now diving into the world of tech, most of my career has been spent in hospitality,  working in fine-dining and Michelin-starred restaurants. Even though I’ve swapped my kitchen tools for coding, I will always be a foodie at heart.
          </p>
          <p style={pTagStyles}>
            Today, I’m fully immersed in the world of web development, currently honing my skills in a Full Stack Web Development bootcamp, with a focus on JavaScript, React, and Node.js. I’m passionate about creating intuitive, user-friendly interfaces and building seamless, efficient applications.
          </p>
          <p style={pTagStyles}>
            Alongside development, I’m deeply interested in UX/UI design, constantly exploring ways to enhance the user experience through thoughtful design and innovation. My journey into tech is driven by a deep curiosity and an ongoing desire to learn and evolve. Whether it’s coding, design, or tackling the next big challenge, I’m always excited to see what’s next.
          </p>
        </div>
      </section>
